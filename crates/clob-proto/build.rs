...
//! `PROTOC` in this process. Since edition 2024 `set_var` is unsafe: another thread may read the
//! environment while it is written, and a build script cannot prove it is alone. Configuring the
//! compiler directly avoids the question.
